...
public:
  virtual ~sbScalar() {}
  virtual sbScalarValue ReadNumber( const char* data ) const { return sbScalarValue::Null(); }
  virtual void WriteNumber( char* data, const sbScalarValue& number ) const {}

  virtual void Convert( char* write_data, const char* read_data, const sbScalar* read_scalar ) const
  {
    sbScalarValue value = read_scalar->ReadNumber( read_data );
    WriteNumber( write_data, value );
  }
...
{
public:
  virtual sbScalarValue ReadNumber( const char* data ) const
  {
